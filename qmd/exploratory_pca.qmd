...
# 4.0 Cut Taxa Tree to Lowest Level


#$ 4.1 Select Level to Cut Taxa and Mesh Size

Change `taxa_lvl` to be lowest level needed.

```{r constant-cut-taxa-tree}
#| echo: false
const <- list(
